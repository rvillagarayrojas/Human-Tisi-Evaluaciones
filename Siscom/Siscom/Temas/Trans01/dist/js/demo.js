...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
          ...
          + "Diseño Fijo"
          + "</label>"
          + "<p>Activar el diseño fijo. No se puede utilizar diseños fijos y en caja en conjunto</p>"
          + "</div>"
          //Boxed layout
          + "<div class='form-group'>"
          + "<label class='control-sidebar-subheading'>"
          ...
          + "</label>"
          + "<p>Ajustar el panel de configuración al lateral derecho</p>"
          + "</div>"
          ...
          + "</label>"
          + "<p>Activar el diseño blanco del panel de configuración</p>"
          + "</div>"
          );
