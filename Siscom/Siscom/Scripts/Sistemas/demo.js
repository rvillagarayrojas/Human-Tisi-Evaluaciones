...
(function ($, AdminLTE) {
    ...
    demo_settings.append(
            ...
            + "Dise&ntilde;o Fijo"
            + "</label>"
            + "<p>Activar el dise&ntilde;o fijo. No se puede utilizar dise&ntilde;os fijos y en caja en conjunto</p>"
            + "</div>"
            //Boxed layout
            + "<div class='form-group'>"
            + "<label class='control-sidebar-subheading'>"
            ...
            + "</label>"
            + "<p>Cambia el estado de la barra lateral izquierda (abierta o colapso)</p>"
            + "</div>"
            //Control Sidebar Toggle
            + "<div class='form-group'>"
            + "<label class='control-sidebar-subheading'>"
            + "<input type='checkbox' data-controlsidebar='control-sidebar-open' class='pull-right'/> "
            + "Ajustar Configuraci&oacute;n"
            + "</label>"
            + "<p>Ajustar el panel de configuraci&oacute;n al lateral derecho</p>"
            + "</div>"
            //Control Sidebar Skin Toggle
            + "<div class='form-group'>"
            + "<label class='control-sidebar-subheading'>"
            + "<input type='checkbox' data-sidebarskin='toggle' class='pull-right'/> "
            + "Panel de Configuraci&oacute;n Blanco"
            + "</label>"
            + "<p>Activar el dise&ntilde;o blanco del panel de configuraci&oacute;n</p>"
            + "</div>"
            );
    ...
    demo_settings.append("<h4 class='control-sidebar-heading'>Dise&ntilde;os</h4>");
